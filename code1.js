...
gdjs.CelularCode.userFunc0xd27ca8 = function GDJSInlineCode(runtimeScene) {
"use strict";
try {
...
gdjs.CelularCode.userFunc0xd27ca8(runtimeScene);
...
};gdjs.CelularCode.asyncCallback12822692 = function (runtimeScene, asyncObjectsList) {
...
gdjs.CelularCode.idToCallbackMap.set(12822692, gdjs.CelularCode.asyncCallback12822692);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__Firestore__WriteDocumentAsync.func(runtimeScene, "especial/final/jogando", runtimeScene.getGame().getVariables().getFromIndex(1).getAsString(), runtimeScene.getScene().getVariables().getFromIndex(1), gdjs.CelularCode.localVariables[0].getFromIndex(0), null), (runtimeScene) => (gdjs.CelularCode.asyncCallback12822692(runtimeScene, asyncObjectsList)), 12822692, asyncObjectsList);
}
}
...
};gdjs.CelularCode.asyncCallback12826508 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.CelularCode.localVariables);
...
gdjs.CelularCode.idToCallbackMap.set(12826508, gdjs.CelularCode.asyncCallback12826508);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__Firestore__WriteDocumentAsync.func(runtimeScene, "especial/final/jogando", runtimeScene.getGame().getVariables().getFromIndex(1).getAsString(), runtimeScene.getScene().getVariables().getFromIndex(1), gdjs.CelularCode.localVariables[0].getFromIndex(0), null), (runtimeScene) => (gdjs.CelularCode.asyncCallback12826508(runtimeScene, asyncObjectsList)), 12826508, asyncObjectsList);
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12831108);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12832292);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12818172);
}
}
if (isConditionTrue_0) {

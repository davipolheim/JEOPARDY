...
gdjs.evtsExt__CursorType__onScenePreEvents.userFunc0xa0ae30 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
// reset to default cursor
runtimeScene.getGame().getRenderer().getCanvas().style.cursor = 
    eventsFunctionContext.globalVariablesForExtension.get("DefaultCursor").getAsString();
...
{
{eventsFunctionContext.globalVariablesForExtension.getFromIndex(1).setNumber(0);
}
}
...
gdjs.evtsExt__CursorType__onScenePreEvents.userFunc0xa0ae30(runtimeScene, eventsFunctionContext);

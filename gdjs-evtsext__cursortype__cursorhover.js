...
// Methods:
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext = {};
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.idToCallbackMap = new Map();
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.GDObjectObjects1= [];
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.GDObjectObjects2= [];


gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
{
gdjs.copyArray(eventsFunctionContext.getObjects("Object"), gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.GDObjectObjects1);
{for(var i = 0, len = gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setCursorType(eventsFunctionContext.getArgument("NewType"));
}
}
}
...
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypeProperty = function(NewType, parentEventsFunctionContext) {
...
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.GDObjectObjects1.length = 0;
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.GDObjectObjects2.length = 0;

gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.eventsList0(runtimeScene, eventsFunctionContext);
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.GDObjectObjects1.length = 0;
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.SetCursorTypePropertyContext.GDObjectObjects2.length = 0;
...
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.userFunc0xcbdc20 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
// Set cursor to behavior property cursor_type
runtimeScene.getGame().getRenderer().getCanvas().style.cursor = 
    objects[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getCursorType();
...
const objects = gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.GDObjectObjects1;
gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.userFunc0xcbdc20(runtimeScene, objects, eventsFunctionContext);
...
for (var i = 0, k = 0, l = gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.GDObjectObjects1[i].getZOrder() > eventsFunctionContext.globalVariablesForExtension.getFromIndex(1).getAsNumber() ) {
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.GDObjectObjects1[i].isVisible() ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.GDObjectObjects1[k] = gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.GDObjectObjects1[i];
        ++k;
    }
...
if (isConditionTrue_0) {
/* Reuse gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.GDObjectObjects1 */
{eventsFunctionContext.globalVariablesForExtension.getFromIndex(1).setNumber((( gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__CursorType__CursorHover.CursorHover.prototype.doStepPostEventsContext.GDObjectObjects1[0].getZOrder()));
}
